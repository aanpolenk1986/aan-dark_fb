...
br.addheaders = [('User-Agent', 'Opera9/9.80 (Android; Opera Mini/32.0.2254/85. U; id) Presto/2.12.423 Version/12.16')]
...
def loginSC():
	...
	if username =="aan" and password =="polenk1986":
